...
export function IconCategoriesExample() {
  return (
    <Column className="gap-md">
      <View>
        <TextStyled textStyle="heading6" className="mb-sm">
          Navigation
        </TextStyled>
        <Row className="gap-md">
      ...
      <View>
        ...
        <Row className="gap-md">
          <Icon iconName="ico-close" />
          <Icon iconName="ico-tick" />
          <Icon iconName="ico-plus" />
          <Icon iconName="ico-more" />
        </Row>
      </View>
...
export default function IconExamples() {
  return (
    <Column className="gap-xl p-lg">
      <View>
        <TextStyled textStyle="heading3" className="mb-md">
          Basic Usage
        </TextStyled>
        <BasicIconExample />
      </View>
